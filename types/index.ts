...
// Use the variable so TypeScript does not report it as unused
...
if (typeof userInput === "string") {
  ...
  // OK -- TypeScript knows it's a string here
}
...
// Reference the function without executing it
console.log("throwError function:", throwError);
...
const formatScore: Formatter = (value) =>
  `${value}%`;

console.log("Student ID:", studentId);
console.log("Position:", position);
console.log("Formatted Score:", formatScore(95.5));
...
// StudentWithCourse must have all User fields
// AND enrolledCourse AND gpa
...
// Use topStudent so TypeScript does not report it as unused
console.log("Top Student:", topStudent.name);
console.log(
  "Enrolled Course:",
  topStudent.enrolledCourse.title
);
